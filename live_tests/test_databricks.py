"""Databricks live connection and reflection tests. Dialect-syntax coverage runs in ``test_databricks_dialect.py``."""
...
def t2s():
    return build_engine_t2s(_ENGINE, engine_schema("DATABRICKS_SCHEMA", "rental_shop"))


def test_databricks_connection_and_reflection(t2s):
