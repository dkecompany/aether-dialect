"""Ask path branches to metadata answers for schema_catalog / domain_knowledge routes."""
...
from aetherdialect._contracts_core import QuestionRoute, QuestionValidationResult, SessionStep
...
def test_schema_catalog_ask_returns_meta_step() -> None:
    ...
    with (
        ...
        patch.object(MainInitOps, "answer_metadata_question", return_value=meta_step) as answer_mock,
    ...
    assert step.answer == "There are 3 tables."
