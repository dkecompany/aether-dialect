"""Unit tests for intent pipeline prompts, session kinds, LLM routing, and SQL shape hints."""
...
class TestHandBuiltSqlShapeHints:
    """Illustrative IR/SQL shape checks for common join and CTE patterns (static strings)."""
