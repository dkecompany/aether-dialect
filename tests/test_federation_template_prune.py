...
def test_prune_preserves_all_fields_on_survivors() -> None:
    with tempfile.TemporaryDirectory() as fed_dir:
        ...
        save_federation_plan_template(fed_dir, _full_template("plan_beta", sources=(("beta", "fp_b"),)))
